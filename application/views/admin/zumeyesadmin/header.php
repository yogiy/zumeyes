<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="<?php echo site_url('admin/profile');?>"><img src="<?php echo base_url();?>assets/upload/<?php echo $this->session->userdata('userimg')?>" alt="logo"/></a>
