                          ...
                          <div class="form-group row" style="margin-top: 1rem;">
                           ...
                           <?php 
                                    ...
                                    foreach ($lense_uses as $key => $lense) {
                                      ...
                                      <div class="form-check form-check-flat">
                            <label class="form-check-label">
                              <input type="checkbox" class="form-check-input" name="lense_uses[]" value="<?php echo $lense->uses;?>">
                               <?php echo @$lense->uses;?>
                            </label>
                            </div>
                          </div>
                      ...
                      <div class="form-group" style="margin-top: 1rem;">
                       ...
                       <div class="form-group" style="margin-top: 1rem;">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" placeholder="Lense Type Example Like  Monthly Disposable" aria-label="Category" name="lense_type" aria-describedby="colored-addon1">
                        </div>
