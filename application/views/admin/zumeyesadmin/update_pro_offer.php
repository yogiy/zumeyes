...
<?php foreach ($offer as $key => $value) {
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" required="" value="<?php echo $offer ?>"aria-label="Category" name="offer" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('offer'); ?>
                      </div>

                      <button type="submit" name="update_offer" value="update_offer" class="btn btn-success mr-2">Submit</button>
