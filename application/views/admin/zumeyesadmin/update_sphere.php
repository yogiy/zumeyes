            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update OS Sphere
...
echo form_open_multipart('admin/update_sphere', $attributes);
?>
<?php foreach ($sphere as $key => $value) {
    $sphere = $value->sphere;
    $id = $value->id;
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $sphere ?>"aria-label="Category" name="sphere" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('sphere'); ?>
                      </div>

                      <button type="submit" name="sphereupdate" value="sphereupdate" class="btn btn-success mr-2">Submit</button>
