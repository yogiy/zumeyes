            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update Tax Slab
...
echo form_open_multipart('admin/update_taxslab', $attributes);
?>
<?php foreach ($tax as $key => $value) {
    $taxslab = $value->tax_slab;
    $id = $value->id;
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" required="" value="<?php echo $taxslab ?>"aria-label="Category" name="tax_slab" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('tax_slab'); ?>
                      </div>

                      <button type="submit" name="update_tax_slab" value="update_tax_slab" class="btn btn-success mr-2">Submit</button>
                   <a href=<?php echo base_url('admin/tax_and_offer'); ?>>Back</a>
                </form>
              </div>
            </div>
          </div>
