...
echo form_open_multipart('admin/update_discount', $attributes);
?>
<?php foreach ($discount as $key => $value) {
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" required value="<?php echo $discount ?>"aria-label="Category" name="discount" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('discount'); ?>
                      </div>

                      <button type="submit" name="discountupdate" value="discountupdate" class="btn btn-success mr-2">Submit</button>
