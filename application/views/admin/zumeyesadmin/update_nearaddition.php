            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update OS Nearaddition
...
echo form_open_multipart('admin/update_nearaddition', $attributes);
?>
<?php foreach ($nearaddition as $key => $value) {
    $nearaddition = $value->nearaddition;
    $id = $value->id;
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $nearaddition ?>"aria-label="Category" name="nearaddition" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('nearaddition'); ?>
                      </div>

                      <button type="submit" name="nearadditionupdate" value="nearadditionupdate" class="btn btn-success mr-2">Submit</button>
                    <a href=<?php echo base_url('admin/lenseinfo'); ?>>Back</a>
                </form>
              </div>
            </div>
          </div>
