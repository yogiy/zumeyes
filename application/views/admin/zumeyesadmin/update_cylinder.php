            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update OS Cylinder
...
echo form_open_multipart('admin/update_cylinder', $attributes);
  ?>
<?php foreach($cylinder as $key => $value){
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $cylinder?>"aria-label="Category" name="cylinder" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('cylinder');?>
                      </div>
                      
                      <button type="submit" name="cylinderupdate" value="cylinderupdate" class="btn btn-success mr-2">Submit</button>
