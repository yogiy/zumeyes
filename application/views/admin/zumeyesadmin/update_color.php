            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update Color Names
...
<?php foreach ($color as $key => $colors) {
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" aria-label="Category" name="color_name" value="<?php echo $color ?>" aria-describedby="colored-addon1">
                        </div>
