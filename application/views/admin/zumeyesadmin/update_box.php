            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update Available Lense Box For Product
...
echo form_open_multipart('admin/update_lensebox', $attributes);
  ?>
<?php foreach($box as $key => $value){
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" required class="form-control" value="<?php echo $box?>"aria-label="Category" name="box" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('box');?>
                      </div>
                      
                      <button type="submit" name="boxupdate" value="boxupdate" class="btn btn-success mr-2">Submit</button>
