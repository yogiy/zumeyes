            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update Material Names
...
<?php foreach ($material as $key => $value) {
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $material ?>" aria-label="Category" name="material_name" aria-describedby="colored-addon1">
                        </div>
