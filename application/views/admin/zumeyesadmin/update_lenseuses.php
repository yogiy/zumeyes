            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update Contact Lense Uses
...
?>
<?php foreach ($lenseuses as $key => $value) {
    $lense_uses = $value->uses;
    $id = $value->id;
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $lense_uses; ?>"" aria-label="Category" name="lense_uses" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('lense_uses'); ?>
                      </div>

                      <button type="submit" name="lense_usess" value="lense_usess" class="btn btn-success mr-2">Submit</button>
