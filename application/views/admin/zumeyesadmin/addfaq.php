         ...
         <div class="row grid-margin">
            <div class="col-lg-12">
              ...
              <?php echo $this->session->flashdata('form_succ_msg');?></span></h4>
                  ...
                  <?php
echo form_open_multipart('admin/addfaq');
  ?>                
                  
                  <textarea id="summernoteExample" name="content"></textarea>
                
                  <input type="submit" name="faq" class="btn btn-primary btn-rounded btn-fw" value="Submit"/>
                </form>
                </div>
              </div>
            </div>
               ...
               foreach ($faq_data as $key => $faq_dat) {
                ...
                $limitedstring = substr($description,0,20);
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo site_url()?>admin/delete_faq?id=<?php echo $id?>" class="btn btn-outline-primary">Delete</a>
                           
                            </td>
                            <td>
                              <a href="<?php echo site_url()?>admin/updatefaq?id=<?php echo $id?>" class="btn btn-outline-primary">Update</a>
                            </td>
                        </tr><?php $sr_no++; }}?>
                              </tbody>
                    </table>                    
