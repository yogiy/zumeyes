            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Update Shape Names
...
?>
<?php foreach ($shape as $key => $value) {
 ...
 <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $shape ?>" aria-label="Category" name="shape" aria-describedby="colored-addon1">
                        </div>
                        <?php echo form_error('shape'); ?>
                      </div>

                      <button type="submit" name="shapee" value="shape" class="btn btn-success mr-2">Submit</button>
