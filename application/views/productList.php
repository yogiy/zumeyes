				...
				<div class="bar clearfix">
					...
					<div class="topFilter clearfix">
						...
						<div class="fieldBar clearfix">
							...
							<div class="field">
								<input type="text" id="byPrize"  list="Prize" placeholder="By Prize">
		...
		$(document).ready(function(){
		   ...
		   var  shortby =document.getElementById("shortby").value;
			...
			$.ajax({
				...
				data:{id:id,action:action,brand:brand,color:color,material:material,shape:shape,fit:fit,purpose:purpose,byPrize:byPrize,shortby:shortby,sid:sid},
