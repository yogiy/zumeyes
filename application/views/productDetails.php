    ...
    <div class="container">
      ...
      <div class="row prescriType clearfix">
        ...
        <ul class="presList clearfix">
          ...
          <input type="text" name="prescription" required value="" id="prescName" placeholder="e.g amanda octobar 2018">
					...
					<div class="box clearfix">
						...
						<div class="button clearfix">
							...
							<a href="#">							
								<span>Add to Cart</span>
								<em>(Submit power post checkout)</em>	
                <input type="radio" value="<?php echo $packages->description?>" required name="prescription">
